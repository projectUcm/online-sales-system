...
export class ProductsComponent implements OnInit {
  ...
  getProductImage(name: string): string {
    ...
    if (n.includes('notebook') || n.includes('laptop'))
      return 'https://picsum.photos/seed/laptop/500/350';
    if (n.includes('mouse'))
      return 'https://picsum.photos/seed/mouse/500/350';
    if (n.includes('monitor') || n.includes('pantalla'))
      return 'https://picsum.photos/seed/monitor/500/350';
    if (n.includes('teclado') || n.includes('keyboard'))
      return 'https://picsum.photos/seed/keyboard/500/350';
    if (n.includes('auricular') || n.includes('headphone') || n.includes('sony'))
      return 'https://picsum.photos/seed/headphones/500/350';
    if (n.includes('webcam') || n.includes('camara'))
      return 'https://picsum.photos/seed/webcam/500/350';
    if (n.includes('ssd') || n.includes('disco'))
      return 'https://picsum.photos/seed/storage/500/350';
    if (n.includes('ram') || n.includes('memoria') || n.includes('corsair'))
      return 'https://picsum.photos/seed/memory/500/350';
    if (n.includes('silla') || n.includes('chair'))
      return 'https://picsum.photos/seed/chair/500/350';
    if (n.includes('pad') || n.includes('mousepad'))
      return 'https://picsum.photos/seed/mousepad/500/350';
    return 'https://picsum.photos/seed/tech/500/350';
  }
